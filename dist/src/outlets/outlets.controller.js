...
__decorate([
    (0, common_1.Post)(),
    (0, check_policies_decorator_1.CheckPolicies)((ability) => ability.can(casl_ability_factory_1.Action.Create, 'Outlet')),
...
__decorate([
    (0, common_1.Get)(),
    (0, check_policies_decorator_1.CheckPolicies)((ability) => ability.can(casl_ability_factory_1.Action.Read, 'Outlet')),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, check_policies_decorator_1.CheckPolicies)((ability) => ability.can(casl_ability_factory_1.Action.Update, 'Outlet')),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, check_policies_decorator_1.CheckPolicies)((ability) => ability.can(casl_ability_factory_1.Action.Delete, 'Outlet')),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
